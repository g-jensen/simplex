...
#[test]
fn zvalue_constructs_from_fraction() {
    ...
    let value = sut::ZValue::from(frac(2,3));
    assert_eq!(sut::ZValue{
        finite: frac(2,3),
        m: Fraction::ZERO
    }, value);
...
#[test]
fn zvalue_constructs_from_fraction_and_m() {
    let value = sut::ZValue::from_m(frac(1,2),frac(3,4));
    assert_eq!(sut::ZValue{
        finite: frac(1,2),
        m: frac(3,4)
    }, value);

    let value = sut::ZValue::from_m(frac(2,3),frac(4,5));
    assert_eq!(sut::ZValue{
        finite: frac(2,3),
        m: frac(4,5)
    }, value);
...
#[test]
fn zvalue_calculates_negative_of_m() {
    let value = sut::ZValue::from_m(Fraction::ZERO,frac(3,4));
    assert_eq!(sut::ZValue{
        finite: Fraction::ZERO,
        m: -frac(3,4)
    }, -value);

    let value = sut::ZValue::from_m(Fraction::ZERO,frac(4,5));
    assert_eq!(sut::ZValue{
        finite: Fraction::ZERO,
        m: -frac(4,5)
    }, -value);
...
#[test]
fn zvalue_formats_finite() {
    let value = sut::ZValue::from(frac(1,2));
    assert_eq!("1/2", value.to_string());

    let value = sut::ZValue::from(frac(2,4));
    assert_eq!("1/2", value.to_string());

    let value = sut::ZValue::from(-frac(6,9));
    assert_eq!("-2/3", value.to_string());
}

#[test]
fn zvalue_formats_m() {
    let value = sut::ZValue::from_m(Fraction::ZERO,frac(1,2));
    assert_eq!("1/2M", value.to_string());

    let value = sut::ZValue::from_m(Fraction::ZERO,frac(2,4));
    assert_eq!("1/2M", value.to_string());

    let value = sut::ZValue::from_m(Fraction::ZERO,-frac(6,9));
    assert_eq!("-2/3M", value.to_string());
}

#[test]
fn zvalue_formats_finite_and_m() {
    let value = sut::ZValue::from_m(frac(1,2),frac(3,4));
