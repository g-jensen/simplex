...
type MObjectiveEquation = ObjectiveEquation<MObjectiveValue>;
    ...
    let problem = MProblem {
        ...
        rows: vec![
            SimplexRow {
                basic_variable: 2,
                equation: Equation {
                    coefficients: vec![frac(6, 1), frac(4, 1), frac(1, 1), frac(0, 1)],
            ...
            SimplexRow {
                basic_variable: 3,
                equation: Equation {
                    coefficients: vec![frac(1, 1), frac(2, 1), frac(0, 1), frac(1, 1)],
                    constraint: frac(6, 1),
                },
                ratio: frac(6, 1),
            },
